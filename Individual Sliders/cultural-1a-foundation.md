...
## Cultural 1A Definition

This guideline measures the observable origin of a culture's moral grammar — the degree to which core moral norms (crime, family structure, sexuality, duty, justice, honesty, charity, etc.) derive from transcendent/religious sources versus secular/immanent sources (human reason, empirical utility, social contract, or material conditions). 

Scoring is based exclusively on empirical reality (observable enforcement in law, education curricula, media narratives, public rituals, institutional governance, and daily cultural reflexes) — never on claims, justifications, official rhetoric, or moral framing.

## Scoring Bands

### High-End Guideline (90–100) — Compressed zone
All major moral forms originate exclusively from transcendent/religious sources. This allows observable variation within different theocratic or religiously-grounded systems (different ways of expressing divine commands in law and culture while retaining zero secular re-working of the underlying grammar).

- **100** = Pure transcendent foundation: every core moral norm is directly and visibly derived from sacred texts, divine commands, or religious tradition with no observable secular re-working or filtering in any domain.
- **95–99** = Near-pure transcendent: moral forms show overwhelming inheritance from religious sources; any secular language is purely instrumental and does not alter the underlying ethical structure or authority.
