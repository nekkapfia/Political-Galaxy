...
Observable empirical reality (actual policies, enforcement patterns, statistical outcomes of cultural transmission, and daily observable treatment) always takes precedence over official rhetoric, self-labeling, or constitutional claims.

**Key Application Guidelines:**
- Focus on what actually happens in practice, not what is claimed or intended.
- Use data, laws, enforcement patterns, cultural outputs, and institutional behavior as primary evidence.
- Avoid speculative or hypothetical scenarios.
- Observable empirical reality always takes precedence.